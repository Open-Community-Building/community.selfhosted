...
| [Claude Web Prompts](specs/claude_prompts.md)     | Draft | Convert the latest Claude snapshot to SQLite and record the conversations.json SHA-256 provenance |
...
weasel run photos
# …or the Claude pipeline (ingest new claude_ingest → convert latest → SQLite):
weasel run claude
